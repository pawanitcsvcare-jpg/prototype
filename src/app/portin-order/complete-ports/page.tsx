...
// -------------------- PAGE --------------------
export default function CompletePortin() {
  return (
    <SidebarProvider
      style={
        {
        ...
        <div className="flex flex-1 flex-col p-6">
          <Card>
            <CardHeader className="border-b py-5">
              <CardTitle>Completed Portin</CardTitle>
            </CardHeader>
            ...
            <CardContent>
              ...
              {/* ---------------- TABLE ---------------- */}
                <div className="overflow-x-auto">
                    <div  className="pull-right text-right mb-3">
                    <DownloadButton text="Download"></DownloadButton>
                    </div>
                             <Table>
                               <TableHeader>
                                 <TableRow>
